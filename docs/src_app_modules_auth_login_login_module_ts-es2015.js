...
class AuthService {
    ...
    login(credentials) {
        ...
        if (credentials.identification === "1250599436" &&
...
/* harmony import */ var src_app_core_auth_auth_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! src/app/core/auth/auth.service */ 88951);
...
/* harmony import */ var ngx_slick_carousel__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ngx-slick-carousel */ 51926);
...
/* harmony import */ var _angular_material_input__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @angular/material/input */ 95076);
...
/* harmony import */ var _angular_material_icon__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @angular/material/icon */ 3323);
...
function LoginComponent_mat_icon_46_Template(rf, ctx) { if (rf & 1) {
...
function LoginComponent_mat_icon_47_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "mat-icon", 42);
...
class LoginComponent {
    constructor(formBuilder, _authService, toastr, router) {
    ...
    createLoginFormGroup() {
        return this.formBuilder.group({
            identification: [{ value: "", disabled: false }, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__.Validators.required]],
            password: [{ value: "", disabled: false }, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__.Validators.required]],
        });
    }
    signIn() {
    ...
    openToast(isCorrect) {
        ...
        const opt = (0,lodash_es__WEBPACK_IMPORTED_MODULE_3__.default)(this.options);
        const inserted = this.toastr.show(message, title, opt, this.options.iconClasses[isCorrect ? "success" : "error"]);
        return inserted;
    }
}
...
LoginComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], decls: 80, vars: 8, consts: [[1, "h-100"], [1, "row", "h-100", "g-0"], [1, "d-none", "d-lg-block", "col-lg-4"], [1, "slider-light"], [1, "slick-slider", "slick-dotted", 3, "config"], ["slickModal", "slick-carousel"], ["ngxSlickItem", ""], [1, "position-relative", "h-100", "d-flex", "justify-content-center", "align-items-center", "bg-light"], [1, "slide-img-bg"], [1, "slider-content", "margin-content-carrousel", "text-light"], ["alt", "img carrousel", "src", "/assets/images/carrousels/seguro-de-vida-del-ecuador-para-ti-y-tu-familia.webp", 1, "img-carrousel"], [1, "text-start", "text-primary", "py-2"], ["alt", "img carrousel", "src", "/assets/images/carrousels/tranquilo.webp", 1, "img-carrousel"], [1, "h-100", "d-flex", "bg-white", "justify-content-center", "align-items-center", "col-md-12", "col-lg-8"], [1, "mx-auto", "app-login-box", "col-sm-12", "col-md-10", "col-lg-9"], [1, "col-lg-6", "offset-lg-3", 3, "formGroup"], [1, "row"], [1, "col-md-12", "text-center"], ["alt", "Logo Seguro", "src", "/assets/images/logo_pichincha.png", 1, "logo-seguro-size"], ["appearance", "outline", 1, "w-100"], ["matInput", "", "placeholder", "Identificaci\u00F3n", "formControlName", "identification"], [4, "ngIf"], ["matInput", "", "placeholder", "Contrase\u00F1a", "formControlName", "password", "type", "password"], ["passwordField", ""], ["mat-button", "", "matSuffix", "", "mat-icon-button", "", "type", "button", 1, "mb-0", "me-0", "border-0", "btn-transition", "btn", "btn-outline-primary", 3, "click"], ["matSuffix", "", 4, "ngIf"], [1, "ms-auto"], [1, "fw-normal", "btn-lg", "btn", "btn-link", 3, "routerLink"], [1, "col-md-12"], [1, "checkbox"], [1, "form-label"], ["type", "checkbox", 3, "checked", "change"], [1, "d-grid", "gap-2"], ["mat-raised-button", "", "color", "primary", 1, "btn-shadow", 3, "disabled", "click"], [1, "mb-0", "py-2"], [1, "text-primary", 3, "routerLink"], [1, "row", "pt-4"], [1, "class-md-12", "text-center"], [1, "input-group", "justify-content-center", "align-items-center", "gap-4"], [1, ""], [1, "input-group-addonmb-2", "me-2", "btn-icon", "btn-shadow", "btn-outline-2x", "btn", "btn-outline-info", "border-0"], [1, "fa", "fa-windows", "btn-icon-wrapper"], ["matSuffix", ""]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](15, " a trav\u00E9s de un equipo humano de grandes valores. ");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](22, " \u00A1Protege la tranquilidad de tus colaboradores con los ");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](35, "Identificaci\u00F3n");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function LoginComponent_Template_button_click_45_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r6); const _r2 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](44); return _r2.type === "password" ? _r2.type = "text" : _r2.type = "password"; });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](53, "\u00BFOlvidaste tu contrase\u00F1a?");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("change", function LoginComponent_Template_input_change_58_listener() { return null; });
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function LoginComponent_Template_button_click_63_listener() { return ctx.signIn(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](64, " Iniciar Sesi\u00F3n ");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](69, " \u00BFNo tienes una cuenta? ");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](76, " Iniciar sesi\u00F3n con: ");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        ...
        const _r2 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](44);
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/router */ 79661);
/* harmony import */ var _login_routing__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./login.routing */ 33466);
...
/* harmony import */ var _login_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./login.component */ 42792);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "loginRoutes": function() { return /* binding */ loginRoutes; }
/* harmony export */ });
/* harmony import */ var _login_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./login.component */ 42792);
...
//# sourceMappingURL=src_app_modules_auth_login_login_module_ts-es2015.js.map